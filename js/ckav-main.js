...
;(function($) {
        ...
        pageTransition: function() {
            ...
            if($o.$navigationLink) {
                $o.$navigationLink.on("click", function(){
                    ...
                    if($o.$innerPage.hasClass("current-page")) {
                        $(".current-page").addClass("prev-page");
                        $o.$innerPage.removeClass("current-page");
                    }
                    else {
                        $o.$innerPage.removeClass("current-page");
                    }
                    ...
                    if(pageType == "main-page") {
                        $o.$ckavBody.removeClass("active-inner-page");
                    }
                    else {
                        $o.$ckavBody.addClass("active-inner-page");
                        $(pageAddress).removeClass("prev-page");
                        $(pageAddress).addClass("current-page");
                    }
                });
            }  
            ...
            if($o.$headerArea) {
                ...
                $(window).scroll(function () {
                    ...
                    if ($(window).scrollTop() > 63) {
                      $o.$headerArea.addClass('navbar-fixed');
                    }
                    if ($(window).scrollTop() < 64) {
                      $o.$headerArea.removeClass('navbar-fixed');
                    }
                });
            }
        }
    ...
    ckav.getObj = function() {
        var obj = {
            ...
            $pageArea           : $(".ckav-page-area").length > 0 ? $(".ckav-page-area") : false,
            $innerPage          : $(".page-wrapper").length > 0 ? $(".page-wrapper") : false,
            $navigationLink     : $(".navigation-a").length > 0 ? $(".navigation-a") : false,
            $headerArea         : $(".ckav-header-area").length > 0 ? $(".ckav-header-area") : false,
        }
        return obj;
    };
